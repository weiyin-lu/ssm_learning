...
//    JSON传递集合
    @RequestMapping("/get1")
    @ResponseBody
    public String get1(@RequestBody List<String> likes) { //从请求体里获取参数，该注解只能使用一次
...
//    JSON传递集合
    @RequestMapping("/get2")
    @ResponseBody
    public String get2(@RequestBody Order order) {
...
//    JSON传递集合
    @RequestMapping("/get3")
    @ResponseBody
    public String get3(@RequestBody List<Order> order) {
